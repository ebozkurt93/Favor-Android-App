...
public class CustomRatingBar extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.rating_full;
    private int mStarOffResource = R.drawable.rating_empty;
    private int mStarHalfResource = R.drawable.rating_half;
